public class Cosmetico extends Loja {
    ...
    public String toString() {
        return "Cosmetico [taxaComercializacao=" + taxaComercializacao + ", nome=" + this.getNome() + ", quantidadeFuncionarios=" + this.getQuantidadeFuncionarios() + ", salarioBaseFuncionario="
